...
const Bhoj = () => {
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(160deg,#fff8ee 0%,#fdf3d8 55%,#fff 100%)', fontFamily: "'Georgia', serif" }}>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-12">
          ...
          <div className="flex-shrink-0 flex flex-col items-center gap-4 w-full max-w-[280px] md:max-w-[300px]">
            ...
            >
              ...
              >
                <span style={{ fontFamily: 'Georgia,serif', fontSize: 40, fontWeight: 900, color: '#e5be10' }}>BU</span>
              </div>
            </div>

            <div className="text-center">
              <p className="text-xs font-bold uppercase tracking-widest" style={{ color: '#753300', letterSpacing: '0.18em' }}>
                Est. 1991
              </p>
              <p className="text-xs mt-1" style={{ color: '#b08060' }}>Bhopal, Madhya Pradesh</p>
            </div>
          </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2
                ...
                style={{ fontFamily: 'Georgia,serif', fontSize: 'clamp(15px,2.5vw,19px)', color: '#3a1a00', margin: 0 }}
              >
                Madhya Pradesh Bhoj (Open) University
              </h2>
            </div>

            <p className="leading-relaxed mb-5" style={{ fontSize: 'clamp(13.5px,1.8vw,15px)', color: '#4a2000', lineHeight: 1.78 }}>
            ...
            <p className="leading-relaxed mb-8" style={{ fontSize: 'clamp(13.5px,1.8vw,15px)', color: '#4a2000', lineHeight: 1.78 }}>
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                >
                  <span className="text-xs uppercase tracking-wider" style={{ color: '#b08060', letterSpacing: '0.12em' }}>
                    {stat.label}
                  </span>
                  <span className="text-sm font-bold mt-0.5" style={{ color: '#753300', fontFamily: 'Georgia,serif' }}>
                    {stat.value}
                  </span>
                </div>
              ))}
        ...
        <div
          ...
          style={{ background: 'linear-gradient(90deg,transparent,#753300 25%,#e5be10 50%,#753300 75%,transparent)' }}
        />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {[
              ...
              <div
                ...
                style={{ background: 'rgba(255,248,238,0.9)', border: '1px solid rgba(229,190,16,0.22)' }}
              >
                <div
                  className="flex-shrink-0 rounded-full mt-1.5"
                  style={{ width: 8, height: 8, background: 'linear-gradient(135deg,#753300,#e5be10)' }}
                />
                <span className="text-sm leading-snug" style={{ color: '#4a2000' }}>{org}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mt-6 flex justify-end">
          <a
            ...
            style={{ color: '#753300', border: '1.5px solid rgba(117,51,0,0.35)', background: 'transparent' }}
            onMouseEnter={(e) => {
