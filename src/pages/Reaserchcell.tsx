		...
		<div className="min-h-screen py-16 sm:py-44 bg-gray-50">
			...
			<div className="max-w-5xl mx-auto px-6 py-14 space-y-10">
				...
				<div className="bg-white border border-gray-200 rounded-2xl p-8 flex gap-6 items-start">
					...
					<div>
						...
						<p className="text-gray-600 leading-relaxed text-sm">
							...
							activities at Govt. Tilak P.G. College, Katni. The objective of the cell is to monitor and
							administer research programs for Faculty and Students, and encourage research activities by
							providing the necessary infrastructural set up to faculty and students at large.
						</p>
					</div>
				</div>
				...
				<div className="bg-blue-50 border border-blue-100 rounded-2xl px-8 py-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
					...
					<a
						href="mailto:research@tilakcollege.ac.in"
