...
const values = [
  ...
  { title: 'Celebrating Diversity', desc: 'Embracing regional, linguistic, class, religious and ideological differences.' },
  { title: 'Confident Womanhood', desc: 'Fostering an identity that is poised and ready for 21st century challenges.' },
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-8 h-8 bg-amber-50 rounded-xl flex items-center justify-center flex-shrink-0">
                    <span className="text-[#753300] text-xs font-semibold">{String(i + 1).padStart(2, '0')}</span>
                  </div>
